...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginPhoto = findViewById(R.id.login_photo);//회원가입 사진

        loginPhoto.setOnClickListener(new View.OnClickListener() {//회원가입 사진눌렀을때
            @Override
    ...
    private void updateUI() {
        ...
        startActivity(HomeActivity);//Home-> 인덴트
        finish();
    }
